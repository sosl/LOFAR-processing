...
lcucommand = "ssh glow605 ssh de605c /data/home/user9/LCU-scripts/PSR_8bit_Scripts/observe-psr-3lane.csh " + Pulsar
if options.Verbose:
...
lofar1command = "ssh lofarD1 '~/PSR_8bit_Scripts/RunLuMP_universal_3quarters.sh " + Pulsar + " " + str(inttime)  + " " + data_dir
...
lofar2command = "ssh lofarD2 '~/PSR_8bit_Scripts/RunLuMP_universal_3quarters.sh " + Pulsar + "  " + str(inttime)  + " " + data_dir
