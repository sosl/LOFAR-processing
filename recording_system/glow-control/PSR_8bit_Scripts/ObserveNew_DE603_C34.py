...
lcucommand = "ssh glow603 ssh de603c killpointing"
...
lcucommand = "ssh glow603 ssh de603c /data/home/user9/LCU-scripts/PSR_8bit_Scripts/observe.csh psr " + Pulsar
if options.Verbose:
...
lofar1command += " " + starttime + " DE603 1 1"
...
lofar2command += " " + starttime + " DE603 2 1"
...
lofar3command += " " + starttime + " DE603 3 1"
...
lofar4command += " " + starttime + " DE603 4 1"
...
lcucommand = "ssh glow603 ssh de603c killpointing " # + Pulsar
lcuproc = os.popen(lcucommand)
