...
lcucommand = "ssh glow605 ssh de605c killpointing"
...
lcucommand = "ssh glow605 ssh de605c /data/home/user9/LCU-scripts/PSR_8bit_Scripts/observe.csh psr " + Pulsar
if options.Verbose:
...
lofar1command = "ssh lofarC1 '~/PSR_8bit_Scripts/RunLuMP_universal.sh " + Pulsar + " " + str(inttime)  + " " + data_dir
lofar1command += " " + starttime + " DE605 1 1"
# the last thre arguments there are: station lane verbosity
lofar1command += " >> ~/PSR_Logs/LuMP_"+data_dir+"_"+Pulsar+"_lane1.log 2>&1' "

lofar2command = "ssh lofarC1 '~/PSR_8bit_Scripts/RunLuMP_universal.sh " + Pulsar + "  " + str(inttime)  + " " + data_dir
lofar2command += " " + starttime + " DE605 2 1"
lofar2command += " >> ~/PSR_Logs/LuMP_"+data_dir+"_"+Pulsar+"_lane2.log 2>&1' "

lofar3command = "ssh lofarC2 '~/PSR_8bit_Scripts/RunLuMP_universal.sh " + Pulsar + " " + str(inttime)  + " " + data_dir
lofar3command += " " + starttime + " DE605 3 1"
lofar3command += " >> ~/PSR_Logs/LuMP_"+data_dir+"_"+Pulsar+"_lane3.log 2>&1' "

lofar4command = "ssh lofarC2 '~/PSR_8bit_Scripts/RunLuMP_universal.sh " + Pulsar + " " + str(inttime)  + " " + data_dir
lofar4command += " " + starttime + " DE605 4 1"
...
lcucommand = "ssh glow605 ssh de605c killpointing " # + Pulsar
lcuproc = os.popen(lcucommand)
