...
lofar1command = "ssh lofarB1 '~/PSR_8bit_Scripts/RunLuMP_universal.sh " + Pulsar + " " + str(inttime)  + " " + data_dir
...
lofar2command = "ssh lofarB2 '~/PSR_8bit_Scripts/RunLuMP_universal.sh " + Pulsar + "  " + str(inttime)  + " " + data_dir
lofar2command += " " + starttime + " DE601 2 1"
lofar2command += " >> ~/PSR_Logs/LuMP_"+data_dir+"_"+Pulsar+"_lane2.log 2>&1' "

lofar3command = "ssh lofarB3 '~/PSR_8bit_Scripts/RunLuMP_universal.sh " + Pulsar + " " + str(inttime)  + " " + data_dir
lofar3command += " " + starttime + " DE601 3 1"
lofar3command += " >> ~/PSR_Logs/LuMP_"+data_dir+"_"+Pulsar+"_lane3.log 2>&1' "

lofar4command = "ssh lofarB4 '~/PSR_8bit_Scripts/RunLuMP_universal.sh " + Pulsar + " " + str(inttime)  + " " + data_dir
