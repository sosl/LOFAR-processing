...
alias rsync_DE602_lofarsrv_noremove='cd /media/scratch/observer/LuMP_DE602_reduced; rmdir */*/*/SubBands_?; rsync --chmod=ug+w -O -av -e "ssh" --progress /media/scratch/observer/LuMP_DE602_reduced/ lofarsrv:/media/part1/observer/LuMP/for_archiving/DE602; cd /media/scratch/observer/LuMP_DE602_reduced/'
alias rsync_DE603_lofarsrv='cd /media/scratch/observer/LuMP_DE603_reduced; rmdir */*/*/SubBands_?; rsync --chmod=ug+w -O -av --remove-source-files -e "ssh" --progress /media/scratch/observer/LuMP_DE603_reduced/ lofarsrv:/media/part1/observer/LuMP/for_archiving/DE603; cd /media/scratch/observer/LuMP_DE603_reduced/; rmdir -p --ignore-fail-on-non-empty */*/*; ls'
alias rsync_DE603_lofarsrv_noremove='cd /media/scratch/observer/LuMP_DE603_reduced; rmdir */*/*/SubBands_?; rsync --chmod=ug+w -O -av -e "ssh" --progress /media/scratch/observer/LuMP_DE603_reduced/ lofarsrv:/media/part1/observer/LuMP/for_archiving/DE603; cd /media/scratch/observer/LuMP_DE603_reduced/'
alias rsync_DE605_lofarsrv='cd /media/scratch/observer/LuMP_DE605_reduced; rmdir */*/*/SubBands_?; rsync --chmod=ug+w -O -av --remove-source-files -e "ssh" --progress /media/scratch/observer/LuMP_DE605_reduced/ lofarsrv:/media/part1/observer/LuMP/for_archiving/DE605; cd /media/scratch/observer/LuMP_DE605_reduced/; rmdir -p --ignore-fail-on-non-empty */*/*; ls'
alias rsync_DE605_lofarsrv_noremove='cd /media/scratch/observer/LuMP_DE605_reduced; rmdir */*/*/SubBands_?; rsync --chmod=ug+w -O -av -e "ssh" --progress /media/scratch/observer/LuMP_DE605_reduced/ lofarsrv:/media/part1/observer/LuMP/for_archiving/DE605; cd /media/scratch/observer/LuMP_DE605_reduced/'
alias rsync_DE609_lofarsrv='cd /media/scratch/observer/LuMP_DE609_reduced; rmdir */*/*/SubBands_?; rsync --chmod=ug+w -O -av --remove-source-files -e "ssh" --progress /media/scratch/observer/LuMP_DE609_reduced/ lofarsrv:/media/part1/observer/LuMP/for_archiving/DE609; cd /media/scratch/observer/LuMP_DE609_reduced/; rmdir -p --ignore-fail-on-non-empty */*/*; ls'
alias rsync_DE609_lofarsrv_noremove='cd /media/scratch/observer/LuMP_DE609_reduced; rmdir */*/*/SubBands_?; rsync --chmod=ug+w -O -av -e "ssh" --progress /media/scratch/observer/LuMP_DE609_reduced/ lofarsrv:/media/part1/observer/LuMP/for_archiving/DE609; cd /media/scratch/observer/LuMP_DE609_reduced/'
