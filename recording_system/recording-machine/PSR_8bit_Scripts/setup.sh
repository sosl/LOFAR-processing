...
alias check_test_obs='cd /media/scratch/observer/LuMP_DE60?_reduced/B*/2*/; . ~/PSR_8bit_Scripts/setup.sh ; ~/PSR_8bit_Scripts/zap.psh -ez B*ar; for x in B*z; do pazi $x; done; rm B*z'
alias check_test_obs_ps='cd /media/scratch/observer/LuMP_DE60?_reduced/B*/2*/; . ~/PSR_8bit_Scripts/setup.sh ; ~/PSR_8bit_Scripts/zap.psh -ez B*ar; psrplot -jDTp -pF -D test_obs.ps/CPS B*z'
