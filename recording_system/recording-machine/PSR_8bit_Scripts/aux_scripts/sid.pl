...
#$lambda = 2.192500336175317; # FR606HBA
$lambda = 6.883636; # DE601
#$lambda = 11.7156; # DE603
#$lambda = 6.3583; # DE605
#$lambda = 2.192488; # FR606
#$lambda = 11.930654; # SE607
#$lambda = -1.434450; # UK608
...
$jd = `~/PSR_8bit_Scripts/aux_scripts/jd.pl \"$UTC\" | grep JD | grep -v MJD | awk '{print \$2}' -`;
chomp $jd;
